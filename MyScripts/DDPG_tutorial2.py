...
class ReplayBuffer(object):
    ...
    def sample_batch(self, batch_size):
        batch = random.sample(self.buffer, self.count) if self.count < batch_size else random.sample(self.buffer,
                                                                                                     batch_size)
...
# Total reward = R(t) + g*R(t+1) + g^2*R(t+2) ....
...
with tf.Session() as sess:
    ...
    critic = CriticNetwork(sess, state_dim, action_dim, CRITIC_LEARNING_RATE, TAU, actor.get_num_trainable_vars(), MINIBATCH_SIZE)
    ...
    for i in range(MAX_EPISODES):
        ...
        print("After episode ", (i+1), ", reward = ", score)
